...
| `latitude`                                   | double                | false          | true        | Earliest `IN_TRANSIT_TO` latitude for vehicle from GTFS-RT [VehiclePosition](https://gtfs.org/realtime/reference/#message-vehicleposition).                                                                                                          | - `allow_inf`: `False`                              |
|                                              |                       |                |             |                                                                                                                                                                                                                                                      | - `allow_nan`: `False`                              |
| `longitude`                                  | double                | false          | true        | Earliest `IN_TRANSIT_TO` longitude for vehicle from GTFS-RT [VehiclePosition](https://gtfs.org/realtime/reference/#message-vehicleposition).                                                                                                         | - `allow_inf`: `False`                              |
|                                              |                       |                |             |                                                                                                                                                                                                                                                      | - `allow_nan`: `False`                              |
