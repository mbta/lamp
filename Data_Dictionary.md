...
| occupancy_status | string | Pipe separated concatenation of `multi_carriage_details` `occupancy_status` values in [CarriageDetails](https://gtfs.org/realtime/reference/#message-CarriageDetails), positionally aligned with `vehicle_consist`. Taken from the [VehiclePosition](https://gtfs.org/realtime/reference/#message-vehicleposition) record that produced `stop_timestamp`, so it describes the vehicle as it arrived at `parent_station`. A carriage reporting no value contributes an empty entry; `NULL` if no carriage on the trip reports a value. Vehicles without automatic passenger counters report `NO_DATA_AVAILABLE`. | GTFS-RT |
| occupancy_percentage | string | Pipe separated concatenation of `multi_carriage_details` `occupancy_percentage` values in [CarriageDetails](https://gtfs.org/realtime/reference/#message-CarriageDetails), sampled and aligned identically to `occupancy_status` | GTFS-RT |
...
| Column Name                                  | Arrow type            | Is primary key | Is nullable | Definition                                                                                                                                                                                                                                           | Constraints                                         |
| ---                                          | ---                   | ---            | ---         | ---                                                                                                                                                                                                                                                  | ---                                                 |
| `trip_id`                                    | large_string          | true           | false       | [`trip_id`](https://gtfs.org/reference/static/#tripstxt)                                                                                                                                                                                             |                                                     |
| `stop_id`                                    | large_string          | false          | false       | [`stop_id`](https://gtfs.org/reference/static/#stopstxt)                                                                                                                                                                                             |                                                     |
| `route_id`                                   | large_string          | true           | false       | [`route_id`](https://gtfs.org/reference/static/#routesxt)                                                                                                                                                                                            |                                                     |
| `gtfs_stop_sequence`                         | int64                 | false          | true        | [`stop_sequence`](https://gtfs.org/documentation/schedule/reference/#stop_timestxt)                                                                                                                                                                  |                                                     |
| `checkpoint_id`                              | large_string          | false          | true        | [`checkpoint_id`](https://github.com/mbta/gtfs-documentation/blob/master/reference/gtfs.md#checkpointstxt)                                                                                                                                           |                                                     |
| `block_id`                                   | large_string          | false          | true        | [`block_id`](https://gtfs.org/documentation/schedule/reference/#tripstxt)                                                                                                                                                                            |                                                     |
| `service_id`                                 | large_string          | false          | true        | [`service_id`](https://gtfs.org/documentation/schedule/reference/#tripstxt)                                                                                                                                                                          |                                                     |
| `route_pattern_id`                           | large_string          | false          | true        | [`route_pattern_id`](https://github.com/mbta/gtfs-documentation/blob/master/reference/gtfs.md#route_patternstxt)                                                                                                                                     |                                                     |
| `route_pattern_typicality`                   | int64                 | false          | true        | [`route_pattern_typicality`](https://github.com/mbta/gtfs-documentation/blob/master/reference/gtfs.md#route_patternstxt)                                                                                                                             |                                                     |
| `direction_id`                               | int8                  | false          | true        | [`direction_id`](https://gtfs.org/reference/static/#tripstxt)                                                                                                                                                                                        |                                                     |
| `direction`                                  | large_string          | false          | true        | Human readable direction of travel for the trip.                                                                                                                                                                                                     |                                                     |
| `direction_destination`                      | large_string          | false          | true        | Terminus of trip.                                                                                                                                                                                                                                    |                                                     |
| `stop_name`                                  | large_string          | false          | true        | [`stop_name`](https://gtfs.org/documentation/schedule/reference/#stopstxt)                                                                                                                                                                           |                                                     |
| `plan_stop_count`                            | uint32                | false          | true        | Total number of scheduled stops for trip.                                                                                                                                                                                                            |                                                     |
| `plan_start_time`                            | int64                 | false          | true        | [`start_time`](https://gtfs.org/documentation/schedule/reference/#stop_timestxt)                                                                                                                                                                     |                                                     |
| `plan_travel_time_seconds`                   | int64                 | false          | true        | Total travel time since previous stop based on scheduled departure times.                                                                                                                                                                            |                                                     |
| `plan_route_direction_headway_seconds`       | int64                 | false          | true        | Headway, based on planned departure times, between the current trip and the next trip in the same route and direction.                                                                                                                               |                                                     |
| `plan_direction_destination_headway_seconds` | int64                 | false          | true        | Headway, based on planned departure times, between the current trip and the next trip in the same direction and destination.                                                                                                                         |                                                     |
| `plan_start_dt`                              | timestamp[us, tz=UTC] | false          | true        | [`start_date`](https://gtfs.org/documentation/schedule/reference/#stop_timestxt)                                                                                                                                                                    |                                                     |
| `plan_stop_departure_dt`                     | timestamp[us, tz=UTC] | false          | false       | Scheduled departure time at stop.                                                                                                                                                                                                                    |                                                     |
| `service_date`                               | date32[day]           | true           | false       | One scheduled day of service starting at 3am and possibly extending into the next calendar day.                                                                                                                                                      |                                                     |
| `stop_sequence`                              | uint32                | true           | false       | Rank of stop crossing for a given `trip_id`, `tm_pullout_id`, and `service_date`. Differs from GTFS and TM variants when sequences do not align.                                                                                                     | - `min`: `1`                                        |
| `tm_pullout_id`                              | large_string          | true           | false       | Unique identifier for a trip & vehicle in TransitMaster. Distinguishes multiple vehicles on the same trip_id.                                                                                                                                        |                                                     |
| `vehicle_label`                              | large_string          | true           | false       | [`vehicle.label`](https://gtfs.org/documentation/realtime/reference/#message-tripdescriptor)                                                                                                                                                         |                                                     |
| `schedule_joined`                            | large_string          | false          | false       | Indicates which dataset(s) were used to form the schedule for a given trip_id, tm_pullout_id, and service_date. `GTFS` indicates GTFS-only data was used. `TM` indicates TransitMaster-only data was used. `JOIN` indicates both datasets were used. |                                                     |
| `tm_stop_sequence`                           | int64                 | false          | true        | Rank of stop crossing for a given TransitMaster trip.                                                                                                                                                                                                |                                                     |
| `pattern_id`                                 | int64                 | false          | true        | TransitMaster pattern_id for a given trip_id and service_date. Joinable to TransitMaster schedule and timepoint datasets.                                                                                                                            |                                                     |
| `point_type`                                 | large_string          | false          | true        | Indicates whether a given stop is the first stop on the route (`start`), the last stop on the route (`end`), or a mid-route stop (`mid`).                                                                                                            |                                                     |
| `timepoint_id`                               | int64                 | false          | true        | TransitMaster timepoint_id for a given trip_id and service_date.                                                                                                                                                                                     |                                                     |
| `timepoint_abbr`                             | large_string          | false          | true        | TransitMaster timepoint_abbr for a given trip_id and service_date.                                                                                                                                                                                   |                                                     |
| `timepoint_name`                             | large_string          | false          | true        | TransitMaster timepoint_name for a given trip_id and service_date.                                                                                                                                                                                   |                                                     |
| `tm_planned_sequence_end`                    | int64                 | false          | true        | TransitMaster single tm_stop_sequence of the planned end timepoint for a given trip-route-pattern.                                                                                                                                                   |                                                     |
| `tm_planned_sequence_start`                  | int64                 | false          | true        | TransitMaster single tm_stop_sequence of the planned start timepoint for a given trip-route-pattern.                                                                                                                                                 |                                                     |
| `timepoint_order`                            | uint32                | false          | true        | Ranked order of planned timepoints for a given trip-route-pattern.                                                                                                                                                                                   |                                                     |
| `plan_stop_departure_sam`                    | int64                 | false          | false       | `plan_stop_departure_dt` expressed as seconds after `service_date`.                                                                                                                                                                                  |                                                     |
| `waiver_remark`                              | large_string          | false          | true        | Bus Ops waiver code; free text entries are removed to avoid exposing identifying information.                                                                                                                                                        | - `regex`: `^([[:alpha:]]{1,5}\|Unrecognized Code)$` |
| `tm_actual_arrival_dt`                       | timestamp[us, tz=UTC] | false          | true        | Actual arrival time at stop from TransitMaster STOP_CROSSING table.                                                                                                                                                                                  |                                                     |
| `tm_actual_departure_dt`                     | timestamp[us, tz=UTC] | false          | true        | Actual departure time at stop from TransitMaster STOP_CROSSING table.                                                                                                                                                                                |                                                     |
| `tm_actual_arrival_time_sam`                 | int64                 | false          | true        | `tm_actual_arrival_dt` expressed as seconds after `service_date`.                                                                                                                                                                                    |                                                     |
| `tm_actual_departure_time_sam`               | int64                 | false          | true        | `tm_actual_departure_dt` expressed as seconds after `service_date`.                                                                                                                                                                                  |                                                     |
| `stop_count`                                 | uint32                | false          | true        | Total number of stops for a given trip.                                                                                                                                                                                                              |                                                     |
| `start_time`                                 | int64                 | false          | true        | [`start_time`](https://gtfs.org/reference/static/#tripstxt)                                                                                                                                                                                          |                                                     |
| `start_dt`                                   | timestamp[us]         | false          | true        | `service_date` + `start_time`                                                                                                                                                                                                                        |                                                     |
| `gtfs_first_in_transit_dt`                   | timestamp[us, tz=UTC] | false          | true        | earliest 'IN_TRANSIT_TO' status `timestamp` for vehicle from GTFS-RT [VehiclePosition](https://gtfs.org/realtime/reference/#message-vehicleposition)                                                                                                 |                                                     |
| `gtfs_last_in_transit_dt`                    | timestamp[us, tz=UTC] | false          | true        | latest 'IN_TRANSIT_TO' status `timestamp` for vehicle from GTFS-RT [VehiclePosition](https://gtfs.org/realtime/reference/#message-vehicleposition)                                                                                                   |                                                     |
| `gtfs_arrival_dt`                            | timestamp[us, tz=UTC] | false          | true        | Timestamp of earliest `STOPPED_AT` message for vehicle from GTFS-RT [VehiclePosition](https://gtfs.org/realtime/reference/#message-vehicleposition)                                                                                                  |                                                     |
| `gtfs_departure_dt`                          | timestamp[us, tz=UTC] | false          | true        | earliest 'STOPPED_AT' status `timestamp` for a trip-stop pair from GTFS-RT [VehiclePosition](https://gtfs.org/realtime/reference/#message-vehicleposition)                                                                                           |                                                     |
| `latitude`                                   | double                | false          | true        | Earliest `IN_TRANSIT_TO` latitude for vehicle from GTFS-RT [VehiclePosition](https://gtfs.org/realtime/reference/#message-vehicleposition).                                                                                                          | - `allow_inf`: `False`<br>- `allow_nan`: `False`                              |
| `longitude`                                  | double                | false          | true        | Earliest `IN_TRANSIT_TO` longitude for vehicle from GTFS-RT [VehiclePosition](https://gtfs.org/realtime/reference/#message-vehicleposition).                                                                                                         | - `allow_inf`: `False`<br>- `allow_nan`: `False`                              |
| `trip_id_gtfs`                               | large_string          | false          | true        | GTFS-RT trip_id before removing overload and rare variant suffixes. Artifact of MBTA's GTFS-RT feed.                                                                                                                                                 |                                                     |
| `public_operator_id`                         | int64                 | false          | true        | Anonymized operator ID joinable to other internal datasets.                                                                                                                                                                                          |                                                     |
| `previous_stop_id`                           | large_string          | false          | true        |                                                                                                                                                                                                                                                  |                                                     |
| `stop_arrival_dt`                            | timestamp[us, tz=UTC] | false          | true        | Estimate of when bus arrived at stop area. Uses `gtfs_arrival_dt` if available, then TransitMaster `actual_arrival_dt` and adjusts time to ensure `stop_sequence` order implies arrival order.                                                       |                                                     |
| `stop_departure_dt`                          | timestamp[us, tz=UTC] | false          | true        | Estimate of when bus departed from stop area. Uses `gtfs_departure_dt` if available, then TransitMaster `actual_departure_dt` and adjusts time to ensure `stop_sequence` order implies departure order.                                              |                                                     |
| `gtfs_first_in_transit_seconds`              | int64                 | false          | true        | `gtfs_first_in_transit_dt` minus `service_date` in seconds.                                                                                                                                                                                          |                                                     |
| `stop_arrival_seconds`                       | int64                 | false          | true        | `stop_arrival_dt` minus `service_date` in seconds.                                                                                                                                                                                                   |                                                     |
| `stop_departure_seconds`                     | int64                 | false          | true        | `stop_departure_dt` minus `service_date` in seconds.                                                                                                                                                                                                 |                                                     |
| `travel_time_seconds`                        | int64                 | false          | true        | Time in seconds between the previous stop's departure and the current stop's arrival. Uses `stop_departure_dt` and `stop_arrival_dt`.                                                                                                                |                                                     |
| `stopped_duration_seconds`                   | int64                 | false          | true        | Time in seconds the bus spent stopped at the current stop. Uses `stop_arrival_dt` and `stop_departure_dt`. As estimates, `travel_time_seconds` does not indicate door events or dwell time.                                                          |                                                     |
| `route_direction_headway_seconds`            | int64                 | false          | true        | Time in seconds between the previous bus and the current bus at the same stop, route, and direction. Uses `stop_arrival_dt` and `stop_departure_dt`.                                                                                                 | - `min`: `0`                                        |
| `direction_destination_headway_seconds`      | int64                 | false          | true        | Time in seconds between the previous bus and the current bus at the same stop, direction, and destination. Uses `stop_arrival_dt` and `stop_departure_dt`.                                                                                           | - `min`: `0`                                        |
| `is_full_trip`                               | bool                  | false          | true        | True if the trip has both a start and end point, otherwise False. Uses `point_type`.                                                                                                                                                                 |                                                     |
