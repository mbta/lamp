...
def _(ds_helper, pl, vehicle_id):
    vp_raw = ds_helper(
        [
            "s3://mbta-ctd-dataplatform-springboard/lamp/RT_VEHICLE_POSITIONS/year=2025/month=9/day=17/2025-09-17T00:00:00.parquet"
        ],
        (pl.col("id") == vehicle_id),
    )
    return (vp_raw,)
