"""update prod stop_sync

Revision ID: f09e853d5672
Revises: 5d9a7ee21ae5
Create Date: 2024-04-01 08:52:01.675273

The sync_stop_sequence update function was disabled during initial loading of
the PROD RDS to improve processing speed, now that PROD has caught up to realtime,
this migration will update all historical sync_stop_sequence values.

Details
* upgrade -> iterate through service_date/static_version_key combos and update sync_stop_sequence
        ...
        stop_sync_update = f"""
            ...
            FROM
                ...
                JOIN (
                    ...
                    AND COALESCE(vehicle_trips.branch_route_id,
                    vehicle_trips.trunk_route_id) = sync_values.route_id
