...
springboard_spare_appointments_with_history = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "appointments_with_history.parquet"))
tableau_spare_appointments_with_history = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "appointments_with_history.parquet"))
spare_resources["appointments_with_history"] = (springboard_spare_appointments_with_history, tableau_spare_appointments_with_history)
springboard_spare_caseForms_with_history = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "caseForms_with_history.parquet"))
tableau_spare_caseForms_with_history = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "caseForms_with_history.parquet"))
spare_resources["caseForms_with_history"] = (springboard_spare_caseForms_with_history, tableau_spare_caseForms_with_history)
...
springboard_spare_caseLetters_with_history = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "caseLetters_with_history.parquet"))
tableau_spare_caseLetters_with_history = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "caseLetters_with_history.parquet"))
spare_resources["caseLetters_with_history"] = (springboard_spare_caseLetters_with_history, tableau_spare_caseLetters_with_history)
...
springboard_spare_cases_with_history = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "cases_with_history.parquet"))
tableau_spare_cases_with_history = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "cases_with_history.parquet"))
spare_resources["cases_with_history"] = (springboard_spare_cases_with_history, tableau_spare_cases_with_history)
springboard_spare_charges_with_history = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "charges_with_history.parquet"))
tableau_spare_charges_with_history = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "charges_with_history.parquet"))
spare_resources["charges_with_history"] = (springboard_spare_charges_with_history, tableau_spare_charges_with_history)
springboard_spare_constraintOverrideActions_with_history = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "constraintOverrideActions_with_history.parquet"))
tableau_spare_constraintOverrideActions_with_history = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "constraintOverrideActions_with_history.parquet"))
spare_resources["constraintOverrideActions_with_history"] = (springboard_spare_constraintOverrideActions_with_history, tableau_spare_constraintOverrideActions_with_history)
...
springboard_spare_duties_with_history = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "duties_with_history.parquet"))
tableau_spare_duties_with_history = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "duties_with_history.parquet"))
spare_resources["duties_with_history"] = (springboard_spare_duties_with_history, tableau_spare_duties_with_history)
springboard_spare_favoriteLocations = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "favoriteLocations.parquet"))
tableau_spare_favoriteLocations = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "favoriteLocations.parquet"))
spare_resources["favoriteLocations"] = (springboard_spare_favoriteLocations, tableau_spare_favoriteLocations)
springboard_spare_favoriteLocations_with_history = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "favoriteLocations_with_history.parquet"))
tableau_spare_favoriteLocations_with_history = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "favoriteLocations_with_history.parquet"))
spare_resources["favoriteLocations_with_history"] = (springboard_spare_favoriteLocations_with_history, tableau_spare_favoriteLocations_with_history)
...
springboard_spare_groupConditions = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "groupConditions.parquet"))
tableau_spare_groupConditions = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "groupConditions.parquet"))
spare_resources["groupConditions"] = (springboard_spare_groupConditions, tableau_spare_groupConditions)
springboard_spare_groupMemberships = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "groupMemberships.parquet"))
tableau_spare_groupMemberships = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "groupMemberships.parquet"))
...
springboard_spare_paymentMethodTypes = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "paymentMethodTypes.parquet"))
tableau_spare_paymentMethodTypes = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "paymentMethodTypes.parquet"))
spare_resources["paymentMethodTypes"] = (springboard_spare_paymentMethodTypes, tableau_spare_paymentMethodTypes)
springboard_spare_paymentMethods = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "paymentMethods.parquet"))
tableau_spare_paymentMethods = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "paymentMethods.parquet"))
...
springboard_spare_requestConstraintOverrides = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "requestConstraintOverrides.parquet"))
tableau_spare_requestConstraintOverrides = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "requestConstraintOverrides.parquet"))
spare_resources["requestConstraintOverrides"] = (springboard_spare_requestConstraintOverrides, tableau_spare_requestConstraintOverrides)
springboard_spare_requestConstraintOverrides_with_history = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "requestConstraintOverrides_with_history.parquet"))
tableau_spare_requestConstraintOverrides_with_history = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "requestConstraintOverrides_with_history.parquet"))
spare_resources["requestConstraintOverrides_with_history"] = (springboard_spare_requestConstraintOverrides_with_history, tableau_spare_requestConstraintOverrides_with_history)
springboard_spare_requestRecurrences = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "requestRecurrences.parquet"))
tableau_spare_requestRecurrences = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "requestRecurrences.parquet"))
...
springboard_spare_requests_with_history = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "requests_with_history.parquet"))
tableau_spare_requests_with_history = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "requests_with_history.parquet"))
spare_resources["requests_with_history"] = (springboard_spare_requests_with_history, tableau_spare_requests_with_history)
...
springboard_spare_userFleetAgreements = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "userFleetAgreements.parquet"))
tableau_spare_userFleetAgreements = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "userFleetAgreements.parquet"))
...
springboard_spare_walletTransactions = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "walletTransactions.parquet"))
tableau_spare_walletTransactions = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "walletTransactions.parquet"))
spare_resources["walletTransactions"] = (springboard_spare_walletTransactions, tableau_spare_walletTransactions)
springboard_spare_walletTransactions_with_history = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "walletTransactions_with_history.parquet"))
tableau_spare_walletTransactions_with_history = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "walletTransactions_with_history.parquet"))
spare_resources["walletTransactions_with_history"] = (springboard_spare_walletTransactions_with_history, tableau_spare_walletTransactions_with_history)
...
springboard_spare_constraintOverrideActions = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "constraintOverrideActions/"))
tableau_spare_constraintOverrideActions = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "constraintOverrideActions.parquet"))
spare_resources["constraintOverrideActions"] = (springboard_spare_constraintOverrideActions, tableau_spare_constraintOverrideActions)
...
springboard_spare_favoriteLocations = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "favoriteLocations/"))
tableau_spare_favoriteLocations = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "favoriteLocations.parquet"))
spare_resources["favoriteLocations"] = (springboard_spare_favoriteLocations, tableau_spare_favoriteLocations)
...
tableau_spare_paymentMethods = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "paymentMethods.parquet"))
spare_resources["paymentMethods"] = (springboard_spare_paymentMethods, tableau_spare_paymentMethods)
springboard_spare_requestConstraintOverrides = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "requestConstraintOverrides/"))
tableau_spare_requestConstraintOverrides = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "requestConstraintOverrides.parquet"))
spare_resources["requestConstraintOverrides"] = (springboard_spare_requestConstraintOverrides, tableau_spare_requestConstraintOverrides)
springboard_spare_requestRecurrences = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "requestRecurrences/"))
tableau_spare_requestRecurrences = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "requestRecurrences.parquet"))
spare_resources["requestRecurrences"] = (springboard_spare_requestRecurrences, tableau_spare_requestRecurrences)
...
tableau_spare_riders = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "riders.parquet"))
spare_resources["riders"] = (springboard_spare_riders, tableau_spare_riders)
springboard_spare_userFleetAgreements = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "userFleetAgreements/"))
tableau_spare_userFleetAgreements = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "userFleetAgreements.parquet"))
spare_resources["userFleetAgreements"] = (springboard_spare_userFleetAgreements, tableau_spare_userFleetAgreements)
springboard_spare_vehicleLocation = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "vehicleLocation/"))
tableau_spare_vehicleLocation = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "vehicleLocation.parquet"))
...
tableau_spare_vehicleLocations = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "vehicleLocations.parquet"))
spare_resources["vehicleLocations"] = (springboard_spare_vehicleLocations, tableau_spare_vehicleLocations)
springboard_spare_walletTransactions = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "walletTransactions/"))
tableau_spare_walletTransactions = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "walletTransactions.parquet"))
spare_resources["walletTransactions"] = (springboard_spare_walletTransactions, tableau_spare_walletTransactions)
...
# spare_resources["requestRecurrences"] = (springboard_spare_requestRecurrences, tableau_spare_requestRecurrences)
# requestRecurrences
# Caught an unexpected error: exploded columns must have matching element counts
# # springboard_spare_fleets = S3Location(bucket=S3_SPRINGBOARD,prefix=os.path.join(SPARE, "fleets.parquet"))
# # tableau_spare_fleets = S3Location(bucket=S3_ARCHIVE, prefix=os.path.join(SPARE_TABLEAU, "fleets.parquet"))
# # spare_resources["fleets"] = (springboard_spare_fleets, tableau_spare_fleets)
