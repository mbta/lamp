...
class RtAlertsDetail(ConfigDetail):
    ...
    def export_schema(self) -> pyarrow.schema:
        return pyarrow.schema([
            ...
            ('header_text_translation', pyarrow.list_(
                pyarrow.struct([
                    pyarrow.field('text',pyarrow.string()),
                    pyarrow.field('language', pyarrow.string()),
                ])
            ...
            ('description_text_translation', pyarrow.list_(
                pyarrow.struct([
                    pyarrow.field('text',pyarrow.string()),
                    pyarrow.field('language', pyarrow.string()),
                ])
            ...
            ('service_effect_text_translation', pyarrow.list_(
                pyarrow.struct([
                    pyarrow.field('text',pyarrow.string()),
                    pyarrow.field('language', pyarrow.string()),
                ])
            ...
            ('timeframe_text_translation', pyarrow.list_(
                pyarrow.struct([
                    pyarrow.field('text',pyarrow.string()),
                    pyarrow.field('language', pyarrow.string()),
                ])
